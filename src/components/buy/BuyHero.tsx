...
export default function BuyHero({ onSearchChange, initialCity = "", initialZipCode = "" }: BuyHeroProps) {
    return (
        ...
        <div className="text-center mb-5 mt-10">
          ...
          >
            <h1 className="font-spartan text-4xl sm:text-5xl md:text-5xl font-bold text-gray-900 mb-1 leading-tight tracking-tight">
              Find Your Perfect
              <span className="block text-green-600 mt-1">Home to Own</span>
            </h1>

            <p className="font-spartan text-lg sm:text-md text-gray-600 max-w-md mx-auto mb-10 font-light">
