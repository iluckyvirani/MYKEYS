...
export default function AddServiceDialog({ open, onOpenChange, onSuccess }: AddServiceDialogProps) {
  ...
  const canSubmit = () => {
    return formData.name && formData.category && formData.basePrice && parseFloat(formData.basePrice) > 0;
  };
        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="mt-2 w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
            >
