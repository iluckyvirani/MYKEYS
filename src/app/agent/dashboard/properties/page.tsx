...
const PACKAGES_PATH = "/agent/dashboard/packages";
...
export default function OwnerPropertiesPage() {
  ...
  useEffect(() => {
    fetchProperties();
    api.get("/owner/packages?audience=AGENT").then((res) => {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Button asChild className="bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
              <Link href="/agent/dashboard/properties/add">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-4 pt-4 border-t border-gray-100">
                    <Link href={`/agent/dashboard/properties/${property.id}`} className="flex-1">
                      <Button variant="outline" size="sm" className="w-full rounded-[5px] cursor-pointer">
                        <Eye className="w-4 h-4 mr-2" />
                        View
                      </Button>
                    </Link>
                    <Link href={`/agent/dashboard/properties/${property.id}/edit`} className="flex-1">
                      <Button variant="outline" size="sm" className="w-full rounded-[5px] cursor-pointer">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-2">
                        <SharePropertyButton
                          ...
                          variant="icon"
                        />
                        <Link href={`/agent/dashboard/properties/${property.id}`}>
                          <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
                            <Eye className="w-4 h-4" />
                          </Button>
                        </Link>
                        <Link href={`/agent/dashboard/properties/${property.id}/edit`}>
                          <Button variant="ghost" size="sm" className="h-8 w-8 p-0">
