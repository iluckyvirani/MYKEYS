...
function ShortRentSearchContent() {
  ...
  useEffect(() => {
    if (!filters.location.trim()) {
      router.replace("/rent/short-rent");
    }
    ...
    <>
      ...
      <main className="min-h-screen bg-white pt-24 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <RentSearchFiltersForm initial={filters} kind="short-rent" />
        </div>
      </main>
      <Footer />
    </>
...
export default function ShortRentSearchPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center">
